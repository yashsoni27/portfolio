...
function Geometries() {
  ...
  const materials = [
    ...
    new THREE.MeshStandardMaterial({ color: 0xf1cf04, roughness: 0.4 }),
    new THREE.MeshStandardMaterial({ color: 0xe700c3, roughness: 0.2 }),
    new THREE.MeshStandardMaterial({ color: 0x8e40ad, roughness: 0.3 }),
    new THREE.MeshStandardMaterial({ color: 0x1ff25f, roughness: 0.1 }),
